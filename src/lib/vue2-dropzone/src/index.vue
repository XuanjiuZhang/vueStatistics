<template>
    <form :action="url" class="vue-dropzone dropzone" :id="id" v-show="!uploadSuccess && !upExcelTypeErr">
        <slot></slot>
    </form>
</template>
        ...
        computed: {
            ...
            cloudIcon: function () {
                if (this.useFontAwesome) {
                    ...
                    return '<span class="el-icon-plus"></span><span style="margin-left: 10px;">上传文档</span>';
                }
            }, 
            doneIcon: function () {
                if (this.useFontAwesome) {
